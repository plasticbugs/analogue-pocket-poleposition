...
# release contains everything needed to produce polepos.rom.
for extra in ("polepos.mra", "README.md", os.path.join("tools", "mra_build.py")):
...
print("build the ROM with:  python3 mra_build.py polepos.mra polepos.zip")
